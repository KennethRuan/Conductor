...
pane = tkinter.Frame(window)
pane.pack(expand=True, fill="both")
pane.configure(background='orange')

#title
title = tkinter.Text(pane, bg = 'orange', font=('Times New Roman', 36), height = 1, highlightthickness = 0, borderwidth=0) #Times New Roman is a bad font for this
...
#     frame.pack()
start = tkinter.Button(pane, bg = '#f5cb42', font=('Times New Roman', 20), highlightthickness = 0, borderwidth=0, text ="Start", height=2, width=10)
